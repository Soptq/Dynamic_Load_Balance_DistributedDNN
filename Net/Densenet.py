...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, growth_rate):
        ...
        self.gn1 = nn.GroupNorm(num_groups=32, num_channels=in_planes)
        self.conv1 = nn.Conv2d(in_planes, 4*growth_rate, kernel_size=1, bias=False)
        self.gn2 = nn.GroupNorm(num_groups=32, num_channels=4 * growth_rate)
...
class Transition(nn.Module):
    def __init__(self, in_planes, out_planes):
        ...
        self.gn = nn.GroupNorm(num_groups=32, num_channels=in_planes)
...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10):
        ...
        self.gn = nn.GroupNorm(num_groups=32, num_channels=num_planes)
